...
namespace IntelliReserve.Migrations
{
    ...
    [Migration("20250608162056_ConfigureAllModelRelations")]
    partial class ConfigureAllModelRelations
    {
            ...
            modelBuilder.Entity("IntelliReserve.Models.Appointment", b =>
                {
                    b.HasOne("IntelliReserve.Models.ServiceSchedule", "ServiceSchedule")
                        .WithOne("Appointment")
                        .HasForeignKey("IntelliReserve.Models.Appointment", "ServiceScheduleId")
